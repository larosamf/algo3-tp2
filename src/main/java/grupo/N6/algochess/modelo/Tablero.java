...
import grupo.N6.algochess.modelo.exepciones.PosicionInvalidaExeption;
...
public class Tablero {
    ...
    public void efectuarPosicionamiento(Unidad unidad,Coordenada posicion) {
        this.ponerUnidad(unidad,posicion);
    }
}
